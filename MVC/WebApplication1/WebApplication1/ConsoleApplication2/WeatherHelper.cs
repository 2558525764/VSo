...
namespace ConsoleApplication2.common
{
   public static class WeatherHelper
    {
       static string appkey = "9610bd99d010d80a88440bb0e13c2027"; //配置您申请的appkey
        ...
        public static Weather ConverToWearther(JsonObject jsonObj)
        {
            ...
            wt.Humidity = jsonObj["result"].Object["sk"].Object["humidty"].Value;
            wt.Temperature = jsonObj["result"].Object["sk"].Object["wind_direction"].Value;
